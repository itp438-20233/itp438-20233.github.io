...
Now make it so once a player dies, they respawn after 5 seconds. To respawn properly requires you to do these three things (in order) ***on the server*** (you can do this in your "kill" function from before):
